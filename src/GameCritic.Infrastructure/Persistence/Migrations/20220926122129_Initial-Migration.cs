        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "money", precision: 3, nullable: false),
                    Playtime = table.Column<double>(type: "float(2)", precision: 2, nullable: true),
                    Score = table.Column<double>(type: "float(2)", precision: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameAwards_Awards_AwardId",
                        column: x => x.AwardId,
                        principalTable: "Awards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameAwards_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameAwards_AwardId",
                table: "GameAwards",
                column: "AwardId");

            migrationBuilder.CreateIndex(
                name: "IX_GameAwards_GameId",
                table: "GameAwards",
                column: "GameId");
